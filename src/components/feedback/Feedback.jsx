...
const Feedback = () => {
  ...
  return (
    <section className="feedback">
      <SectionTitle className="feedback__title">
        What Our Client Are&nbsp;<MarkingText>Saying</MarkingText>
      </SectionTitle>
        ...
        <div className="feedback__info">
          ...
          <div className="feedback__bottom">
            <div className="feedback__author">
              <MarkingText className="feedback__author-name">
                {feedbackData[slideIndex].author}
              </MarkingText>
              <div className="feedback__author-shortdescr">
                {feedbackData[slideIndex].aboutAuthor}
              </div>
            </div>
