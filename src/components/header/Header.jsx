    ...
    return (
        <>
            <header className="header">
                <div className="header__inner">
                    ...
                    <div className={burgerState ? "burgerActive" : "header__panel"}>
                        ...
                        {!authUser ? <Button className="header__button" onClick={openModalAuth}>Sign Up</Button> : 
            ...
            {modalState === "auth-open" && 
                (<Modal closeModal={closeModal} className={authUser && 'modal__notification'}>
                    <div className="modal__title">Authorisation</div>
                    <SignUpForm authState={authState} />
                </Modal>)
            }
            {modalState === "cart-open" && <Cart closeModal={closeModal} cartItems={cartItems}  cartActions={cartActions}/>}
